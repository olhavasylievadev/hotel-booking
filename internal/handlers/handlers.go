...
import (
	...
	"github.com/olhavasylievadev/hotel-booking/internal/driver"
	"github.com/olhavasylievadev/hotel-booking/internal/forms"
	"github.com/olhavasylievadev/hotel-booking/internal/helpers"
	"github.com/olhavasylievadev/hotel-booking/internal/models"
	"github.com/olhavasylievadev/hotel-booking/internal/render"
	"github.com/olhavasylievadev/hotel-booking/internal/repository"
	"github.com/olhavasylievadev/hotel-booking/internal/repository/dbrepo"
	"log"
	"net/http"
	"strconv"
	"strings"
...
func (m *Repository) PostReservation(w http.ResponseWriter, r *http.Request) {
	...
	if !ok {
		helpers.ServerError(w, errors.New("cannot get info from session"))
		return
	}
	...
	reservation.Email = r.Form.Get("email_address")
	...
	htmlMessage := fmt.Sprintf(`
		<strong>Resesrvation Confirmation</strong><br/>
		Dear %s, <br/>
...
`, reservation.FirstName, reservation.StartDate.Format("2006-01-02"), reservation.EndDate.Format("2006-01-02"))
	...
	// send notification to a property owner
	htmlMessage = fmt.Sprintf(`
		<strong>Resesrvation Notification</strong><br/>
...
func (m *Repository) PostAvailability(w http.ResponseWriter, r *http.Request) {
	...
	if len(rooms) == 0 {
		//no availability
		m.App.Session.Put(r.Context(), "error", "No available rooms for these dates")
...
func (m *Repository) AvailabilityJSON(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		helpers.ServerError(w, errors.New("cannot get end date"))
		return
	}

	roomID, err := strconv.Atoi(r.Form.Get("room_id"))
	if err != nil {
		helpers.ServerError(w, errors.New("cannot get room id"))
		return
	}
...
// ChooseRoom displays list of available rooms to book for specific dates
...
func (m *Repository) BookRoom(w http.ResponseWriter, r *http.Request) {
	...
	startDate, err := time.Parse(layout, sd)
	if err != nil {
		helpers.ServerError(w, errors.New("cannot get start date"))
		return
	}
	endDate, err := time.Parse(layout, ed)
	if err != nil {
